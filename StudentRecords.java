...
public class StudentRecords {
	...
	//creates a new student and adds student to array
...
//		newStudent.setGpa(Float.parseFloat(gpa));
	...
	//removes student from array based on index
...
//				if((pos+1)==(studentArray.size()-index)) {
...
//			}
	...
	//retrieves info based on student index
	...
	//sets text fields to current student info
	...
	//takes changes from textfields, creates new student, adds to student array
