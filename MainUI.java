/*
 * Project 2- Student/Employee Records GUI
 * Jakob, Rodrigo, Yuzhe, Kaiyu
 * 
 * This program allows the user to enter new student/employee information, remove info, view info, and modify info.
 * The information is written and stored in text files. (StudentRecords.txt and EmployeeRecords.txt)
 * 
 * Rodrigo- Learned and implemented CardLayout, worked on AddEmpCard and RemoveEmpCard
 * Kaiyu- Tried to get the interfaces working and added label decorations
 * Yuzhe- Fixed remove function problems and worked on ViewStuCard
 * Jakob- Organized layout of all cards and MainUI, worked on read and write functions, and adusted Student/EmployeeRecords.java files to account for other functions 
 */
