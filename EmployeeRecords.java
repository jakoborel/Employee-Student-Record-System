...
//			return;
//		}
		Employee newEmployee = new Employee(fname, lname, phone, email, address, emContact, Integer.parseInt(age), category, department, salaryType, Integer.parseInt(salary));
